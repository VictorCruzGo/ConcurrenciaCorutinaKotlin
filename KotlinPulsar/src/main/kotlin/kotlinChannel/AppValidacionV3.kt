...
fun main() {
    ...
    Tiempos con:
    //2000 facturas
    Channel.UNLIMITED = 344

    //100000 facturas
    Channel.UNLIMITED = 3606
    */
    val nroFacturas = 10
    ...
    var t = measureTimeMillis {
        runBlocking {
            ...
            launch {
                ...
                val validaciones = List(nroFacturas) {
                    launch{
                ...
                println("Antes del foreach")
                validaciones.forEach { it.join()}
                println("canal para registrar cerrado:::"+validaciones.size)
